...
if(username != null && password != null){
    try {
        PreparedStatement ps = con.prepareStatement(
            "SELECT * FROM users WHERE username=? AND password=? AND role='hr'"
        );
...
<header class="topbar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="hr-login.jsp" class="active"><i class="bi bi-people-fill"></i> HR</a></li>
...
<div class="main-area">
    <div class="login-wrapper">
        ...
        <div class="login-top">
            <div class="login-avatar"><i class="bi bi-people-fill"></i></div>
            <div class="login-eyebrow">Human Resources</div>
            <div class="login-title">HR Portal Login</div>
            <div class="login-subtitle">Sign in to access your HR management dashboard</div>
        </div>
        ...
        <div class="login-card">
            ...
            <div class="perm-chips">
                <span class="perm-chip"><i class="bi bi-cash-stack me-1"></i>Payroll</span>
                <span class="perm-chip"><i class="bi bi-people me-1"></i>Onboarding</span>
                <span class="perm-chip"><i class="bi bi-calendar-check me-1"></i>Leave Approval</span>
                <span class="perm-chip"><i class="bi bi-bar-chart me-1"></i>Reports</span>
            </div>

            <form method="post">
                <label class="f-label">HR Username</label>
                ...
                <div class="form-footer-row">
                    ...
                    <a href="hr-forgot-password.jsp">Forgot password?</a>
                </div>

                <button type="submit" class="login-btn">
                    <i class="bi bi-box-arrow-in-right"></i> Sign In to HR Panel
                </button>
            </form>

            <div class="divider">HR division access only</div>

            <div class="security-note">
                <i class="bi bi-shield-check-fill"></i>
                Access is restricted to authorized HR personnel. All sessions are monitored.
            </div>
        </div>
...
<footer class="site-footer">
    &copy; 2026 Employee Management System &mdash; Built by <strong style="color:rgba(10,60,40,0.50);">Abhishek Samadhiya</strong>
</footer>
